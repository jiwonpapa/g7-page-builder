...
상태: 4-B 제한 반응형 구현 반영. 4-C 기본 생성·전환 UI 결정과 제품 버전 발행은 후속입니다.
...
| compiler_version | HtmlDocumentCompiler의 0.19.0 | v1 sanitizer 안전 출력, v2 재귀 구조와 유한 태블릿·모바일 override class 출력을 함께 판정 |
