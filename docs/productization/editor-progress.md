...
|---|---|---|---|---|---|
| 1차 · 공식 연동 계약과 원본 보존 | NE1 · 공식 연동 계약과 원본 보존 | 차단 | 없음 | native-ne1-foundation-20260907 | 미완료 |
...
- 차단 NE1: PB 원본 보존·평문 변경 후보와 32개 단위 시험은 검증됨. G7 공개 H01~H04 문맥·경로·명령·패널 계약이 현재 미제공이며 AGENTS/NE1의 별도 G7 코어 수정 승인 필요. native-host-contract.md의 구체적 변경안 확보. G7 적용·Undo·저장·재열기 NAT-01 미검증이므로 NE1 미완료.
