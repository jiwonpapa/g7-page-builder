...
const budgets = [
  ...
  // UI5 measured candidate: 507,212 gzip bytes before final browser corrections; reserve 288 bytes for the Card integration.
  { path: 'dist/js/page-builder-editor.iife.js', gzip: 507_500 },
