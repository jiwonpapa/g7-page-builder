...
기준 소스 SHA는 `58ed8a33829fdcb1327d730c6ab6da953f656949`입니다. 조사 당시 내장 정의45종·preset95종이며, 호환 전용 HeroSplit 정의1개를 숨겨 당시 기본 갤러리 후보는139개입니다. 외부 팩 포함 실환경 총수나 품질 합격 수가 아닙니다. 구조3종은 별도 등록입니다. EP2-01에서 기본 요소 3종을 추가해 내장 정의48종·preset98종, 호환 전용 1종을 뺀 후보145개로 확장합니다. 실제 검증 완료 여부는 진척 원장을 따릅니다.
...
불완전한 내용도 초안으로 보존하는 기존 정책을 유지하며 컴파일·미리보기·발행에서 내용 계약을 검증합니다. 구조·버전 위반은 초안 저장부터 거부합니다. 마지막 정상 발행본은 어느 실패에서도 보존합니다. 추가 타입은 block version 1, 기존 문서 v1/v2는 유지하고 내장 Pack 0.16.0은 Page Builder >=0.34.0을 요구합니다. 과거 140개 품질 승인 기록은 새 6개 카탈로그 항목의 승인으로 승격하지 않습니다.
