...
import { externalEditorName, type ExternalEditorName, type ExternalRawConfig } from './externalEditorData';
...
export interface ExternalBlockEditorRegistration {
  ...
  components: Record<string, ExternalRawConfig>;
}
...
export function registerExternalEditor(registration: ExternalBlockEditorRegistration): void {
...
export function externalEditorRegistrations(): IterableIterator<ExternalBlockEditorRegistration> {
