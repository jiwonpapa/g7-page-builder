...
환경 완료와 Page Builder 제품 완료는 다릅니다. 현재 별도 관리자 메뉴, 37종 block·18개 내장 프리셋의 manifest·editor·compiler·renderer, MediaPort 업로드·다운로드 자산 선택, 문의함·지도, 문서 보관/복원, 핵심 편집·미리보기·발행·복원·공개 해제 E2E, 릴리스 패키징과 스테이징 배포 하네스는 구현됐습니다. 시각 baseline 확대는 다음 제품 범위입니다.
