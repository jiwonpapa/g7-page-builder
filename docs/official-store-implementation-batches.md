# 지원소프트 공식 무료 배포 프로토타입 구현 배치

기준 버전: `0.10.0`

이 배치는 Page Builder 내부의 정적 catalog fixture, 소비자 브라우저,
설치·적용 검증을 구현한 기록입니다. 독립 마켓 모듈과 관리 시스템은
구현하지 않았습니다. 향후 작업 범위와 착수 게이트는
[Market 모듈 스펙 주도 개발 명세](market-module-spec.md)를 기준으로 합니다.
